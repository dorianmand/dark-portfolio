...
export function SelectedWorks() {
  return (
    <section id="work" className="relative bg-white py-12 md:py-16">
      <div className="mx-auto max-w-[1200px] px-6 md:px-10 lg:px-16">
        <SectionHeader eyebrow="Selected Work" title="Featured" italic="projects" subtext="A selection of projects I've worked on, from concept to launch." action={<a className="gradient-border relative hidden rounded-full bg-black px-6 py-3 text-sm text-white md:inline-flex">View all work →</a>} />
